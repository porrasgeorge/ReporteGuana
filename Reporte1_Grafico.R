...
saveWorkbook(wb, "C:/Data Science/ArhivosGenerados/Coopeguanacaste/Coopeguanacaste_Reporte1.xlsx", overwrite = TRUE)


## Reporte 2 Valores porcentuales
wb2 <- createWorkbook()
ws2 <- addWorksheet(wb2, "Reporte")
...
saveWorkbook(wb2, "C:/Data Science/ArhivosGenerados/Coopeguanacaste/CoopeGuanacaste_Reporte2.xlsx", overwrite = T)
